...
| 「傳給」「傳檔案給」「收檔案」「收 Drive」「drive transfer」 | drive-transfer | `ai-core/skills/drive-transfer.md` |
...
| 「英文課設計」「English lesson」 | english-overlay | `ai-core/skills/english-overlay.md`（由 lesson-engine 載入） |
| 「文學課設計」「語文課」「臺灣文學」「literature」 | literature-overlay | `ai-core/skills/literature-overlay.md`（由 lesson-engine 載入） |
...
| 「評估課程」「evaluate」「跑品質檢查」「課程評估」「評估教案」 | lesson-evaluator | `ai-core/skills/lesson-evaluator.md` |
| 「發布」「組裝上傳」「跑管線」「publish」「assemble and upload」「組裝並上傳」 | publish-pipeline | `ai-core/skills/publish-pipeline.md` |
| 「NotebookLM」「NotebookLM 做簡報/影片/語音/資訊圖表/測驗/報告/心智圖/學習卡/資料表」 | notebooklm | `ai-core/skills/notebooklm.md` |
