...
"""
    ...
    suggest_tests = [
        ...
        # ── 獨立專案必須歸入專案名區段，不可掉到根目錄散檔 ──
        ("workspaces/Working_Member/Codeowner_David/projects/botany-grade5/stories/B001/content.md",
         ("David 的工作空間", "botany-grade5")),
        ("workspaces/Working_Member/Codeowner_David/projects/botany-grade5/project.yaml",
         ("David 的工作空間", "botany-grade5")),
        ("workspaces/Working_Member/Codeowner_David/projects/botany-grade5/kovacs-chapters/02_The_Dandelion.md",
         ("David 的工作空間", "botany-grade5")),
        ("workspaces/Working_Member/Codeowner_David/projects/stories-of-taiwan/stories/A-origins/A005/content.md",
         ("David 的工作空間", "stories-of-taiwan")),
        ("workspaces/Working_Member/Codeowner_David/projects/taiwanese-history/gallery.md",
         ("David 的工作空間", "taiwanese-history")),
