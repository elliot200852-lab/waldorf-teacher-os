...
print_summary() {
  print_section "Step 6: Setup Complete"
  ...
  echo "  - Working branch: main (all teachers work on main)"
  echo "  - Run: bash setup/start.sh (Mac/Linux) or .\\setup\\start.ps1 (Windows)"
  echo ""
